...
\subsubsection{SSH-Verbindung herstellen}
...
\begin{verbatim}
sudo nmcli connection add type wifi ifname wlan0 con-name tuwifi ssid "DEIN_WLAN"
\end{verbatim}

\subsubsection{Schritt 2: Sicherheit explizit festlegen (WPA2)}

\begin{verbatim}
sudo nmcli connection modify tuwifi wifi-sec.key-mgmt wpa-psk
\end{verbatim}

\subsubsection{Schritt 3: WLAN-Passwort setzen}

\begin{verbatim}
sudo nmcli connection modify tuwifi wifi-sec.psk "DEIN_PASSWORT"
\end{verbatim}

\subsubsection{Schritt 4: WLAN-Verbindung aktivieren}

\begin{verbatim}
sudo nmcli connection up tuwifi
\end{verbatim}
