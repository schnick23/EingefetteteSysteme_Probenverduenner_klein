...
\TODO{Bei diesem Skript ist der vordere Endtaster deaktiviert. Nach jedem Vorwärtsschritt ist durch $h$ zu homen. Im Notfall kann durch} \texttt{strg + c} \TODO{abgebrochen werden. Der Hubtisch muss vor dem Start auch in der Home-Position stehen (ganz unten).}\\
